...
public interface RiskListService {
	...
	void updateRiskSeverity(RiskSeverityMaster riskSevFromUI);
	...
	void updateRiskLikeHood(RiskLikeHoodMaster riskLikeFromUI);
	...
	List<RiskHazardTraceabilityMatrixDTO> riskHazardTraceService(Integer productId);
}
