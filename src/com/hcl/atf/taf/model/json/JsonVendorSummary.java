...
public class JsonVendorSummary implements java.io.Serializable {
	private static final Log log = LogFactory.getLog(JsonResourcePool.class);
	
	@JsonProperty
	private Integer jsonVendorSummaryId;
	@JsonProperty
	...
	public JsonVendorSummary() {
	}

	public JsonVendorSummary(TestfactoryResourcePool resourcePool) {		
	}
