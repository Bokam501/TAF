...
public interface DataSourceExtractorDAO {
	...
	void updateDataExtractorScheduleMaster(DataExtractorScheduleMaster dataExtractorScheduleMaster);
	DataExtractorScheduleMaster getDataExtractorScheduleMasterById(int dataExtractorScheduleMasterId);
