...
public interface SchedulerService {
     ...
     * @throws ATFException -
     */
    Date scheduleCronJob(TestConfigScheduleEntity testConfigSchedule) throws ATFException;
     ...
     * @throws ATFException -
     */
    Date reScheduleCronJob(String productName, String triggerOldName, String triggerNewName, String description,
            String cronExpString) throws ATFException;
     ...
     * @throws ATFException -
     */
    Boolean deleteJob(String productName, String jobName) throws ATFException;
     ...
     * @throws ATFException -
     */
    void createJob(String productName, String jobName, String jobDescription, String jobClassName) throws ATFException;
     ...
     * @throws ATFException -
     */
    void updateJob(String productName, String jobName, String jobDescription, String jobClassName) throws ATFException;
     ...
     * @throws ATFException -
     */
    Date addCronTriggerToJob(String productName, String jobName, String triggerName, String triggerDescription,
            String cronExpression) throws ATFException;
     ...
     * @throws ATFException -
     */
    void runJobNow(String jobName, String productName) throws ATFException;
     ...
     *             ATFException
     */
    Boolean isJobExist(final String jobName, final String productName) throws ATFException;
     ...
     * @throws ATFException -
     */
    JobTriggerDetail getJobByName(String productName, String jobName) throws ATFException;
     ...
     *             throws ATFException
     */
    Date getTriggerNextFireTime(String productName, String triggerName) throws ATFException;
