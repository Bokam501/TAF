...
<body>
						...
						<div class="portlet light ">
							<div class="portlet-title toolbarFullScreen">
								<div class="caption caption-md">
									<span class="caption-subject theme-font bold uppercase">My Audits
							...
							<div class="portlet-body form">
								<div class="row">
									...
									<div class="scroller" style="height: 500px" data-always-visible="1" data-rail-visible1="1">
						 				<div id="dataTableSingleContainer"></div>
						 			</div>			 																
								</div>
							</div>
	...
	<script type="text/javascript">
		jQuery(document).ready(function() {	
			...
			var getUserId='<%=session.getAttribute("ssnHdnUserId")%>';
			
			function assignUserAuditHistoryDataTableValues(jsonObj){
				openLoaderIcon();
				 $.ajax({
					  type: "POST",
					  url:jsonObj.url,
			...
			var url='administration.event.list.by.userId?userId='+getUserId+'&jtStartIndex=0&jtPageSize=1000';
			var jsonObj={"Title":" Audit History:",
					"url": url,	
					"jtStartIndex":0,
					"jtPageSize":1000,					
			};
			assignUserAuditHistoryDataTableValues(jsonObj);
		});
	</script>

	<!-- <script type="text/javascript" src="js/viewScript/customFieldConfiguration.js"></script>
	<script type="text/javascript" src="js/viewScript/botCommandMaster.js"></script> -->
