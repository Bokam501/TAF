					...
					<div class="col-md-12">
						...
						<div class="portlet light "style="min-height: 440px;overflow: auto">
							...
							<div class="portlet-body">								
 								...
 								<!-- <div id="pdtMode" class="tabbable tabbable-tabdrop" style="display:none;"> -->
								<div id="pdtMode" style="display:none;">
										<ul class="nav nav-tabs toolbarFullScreen" id="tabslist">
											...
											<!-- <li><a href="#Testcases" data-toggle="tab">Testcases</a></li>											
											<li><a href="#Testcasescripts" data-toggle="tab">Test Scripts</a></li>
											<li><a href="#Testsuites" data-toggle="tab">Test Suites</a></li>-->
											<!-- <li><a href="#FeatureTestCases" data-toggle="tab">Traceability</a></li> -->
											...
											<!-- <li><a href="#TestRunPlanTab" data-toggle="tab">Test Plan</a></li> -->
											<!-- <li><a href="#ProductTeamResources" data-toggle="tab">Team</a></li> -->
											<li><a href="#TeamTabPage" data-toggle="tab">Team</a></li>
											<!-- <li><a href="#productBots" data-toggle="tab">Bots</a></li> -->
											<li><a href="#UserGroup" data-toggle="tab">User Group</a></li>
											<!--<li style="display: none"><a href="#CoreResources" data-toggle="tab">Flex Testing Team</a></li> -->
											<li><a href="#ChangeRequests" data-toggle="tab">Change Requests</a></li>
											<li><a href="#Risks" data-toggle="tab">Risks</a></li>
											<!-- <li><a href="#TraceabilityReport" data-toggle="tab">Traceability Reports</a></li> -->
											<!-- <li><a href="#AutomationScripts" data-toggle="tab">Automation Scripts</a></li> -->
											<!-- <li><a href="#TestData" data-toggle="tab">Test Data</a></li> -->
											<!-- <li><a href="#TeamUtilization" data-toggle="tab">Team Utilization</a></li> -->
											<!-- <li><a href="#MappingFeatureToBuild" data-toggle="tab">Mapping Feature To Build</a></li> -->
											<!-- <li><a href="#defectReport" data-toggle="tab">Defect Report</a></li> -->
										<!-- 	<li><a href="#FeatureTestCases" data-toggle="tab">Feature Test Case Plan</a></li> -->
<!-- 											<li><a href="#DecouplingPlan" data-toggle="tab">Decoupling Plan</a></li> -->
<!-- 											<li><a href="#Terminal" data-toggle="tab">Terminal</a></li> -->											
<!-- 											<li><a href="VersionTestCaseMapping" data-toggle="tab">TestCase Versioning</a></li> -->
										</ul>
									</div>
								...
								<div class="tab-content" id="tbCntnt" style="display:none;">
									...
									<!-- Testcases  -->
									 <!-- <div id="Testcases" class="tab-pane fade"> --> 
										...
										<!-- <div id="testCaseStatusFilter_dd" class="col-md-4" style="float:right;position: absolute;Z-index:1;right: 230px;top: 130px;""> -->
										<!-- <div id="testCaseStatusFilter_dd" style="position: absolute;z-index: 10;right: 165px;margin-top: 3px;display: block;">
										...
										<!-- ContainerBox -->
										<!--<div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top: 5px;position: relative; max-height: 230px;">
											<div class="col-md-2 jScrollTitleContainer" style="position: absolute;z-index: 10;width: 470px;margin-left: 145px;margin-top: 6px;float:left">												
												...
												<input style="margin-left: 4px;height: 26px;background-color:  #55616f; font-size: 0.9em;padding-top: 3px;margin-top: 2px;"
				           			  				type="button" class="btn blue" id="testCaseGroup" onclick="testCaseGroupHandler(event)" value="Test Scenario">
													
												<img src="css/images/dt_download_features.png" title="Download Test Scripts" class="icon_imgSize showHandCursor" 
												alt="Download" onclick="return displayDownloadTestScriptsFromTestCases(productId,'Product','Download')";/>													
											</div>	-->
											<!--<div id="jTableContainertest" class ="jTableContainerFullScreen"></div>
										</div>-->
										<!-- <div id="jTableContainertest" class ="jTableContainerFullScreen"></div> -->
										<!-- End Container Box -->
									<!-- </div> -->
									...
									<!-- TestScripts  -->
									<!-- <div id="Testcasescripts" class="tab-pane fade">
										...
										ContainerBox
										<div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top: 5px;position: relative; max-height: 230px;">
											<div class="col-md-2 jScrollTitleContainer" style="position: absolute;z-index: 10;width: 400px;margin-left: 145px;margin-top: 6px;float:left">																										           			  																																																
											</div>											
									...
									<div id="Features" class="tab-pane fade">
										...
										<!--<div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top:5px;position: relative;min-height: 270px;">
											<div class="row jScrollTitleContainer" style="position: absolute;z-index: 10;width: 650px;margin-left: 150px">
													<!-- ContainerBox 
													<div class="col-lg-9" style="margin-left: 0px;">															
														<input type="button"  class="btn blue" id="trigUploadOfProductFeatures" value="Product Features" style=" margin-top: -2px;
														   font-size: .9em;height: 26px;background-color: #55616f;padding-top: 4px" />
														<span id="productFeaturefileName"></span>
														<input id="uploadFileOfProductFeatures" type="file" name="uploadFileOfProductFeatures" style="display:none;"
														   onclick="{this.value = null;};" onchange="importProductFeatures(event);" />
														<img src="css/images/dt_download_features.png" title="Download Template - Product Features" class="icon_imgSize showHandCursor" 
															alt="Download" onclick="downloadTemplateProductFeature();">
														<input style="margin-left: 4px;height: 26px;background-color:  #55616f;font-size: 0.9em;padding-top: 3px;margin-top: 2px;" type="button" class="btn blue" 
															id="mappingFeatureToBuild" onclick="mappingFeatureToBuidHandler(event)" value="Mapping Feature To Build">  
													</div> -->
													<!-- Changes for Bug : 717
													//TAF-iLCM integration 
												<div class="col-lg-1" style="display:none; margin-left: 225px;margin-top: -36px">	
														<label style="padding-right: 10px;padding-top: 10px;color: #FFF;font-size: 1.1em">Import :</label>												
														<a style="margin-top: 0px;font-size: .9em;height: 26px;background-color: #55616f;padding-top: 4px" 
														  href="javascript:importProductFeaturesTMS();" class="btn blue button-next">TMSProductFeatures</a>
													 </div>
													 <div id="filterForFeatures" style="float:right;">
														<div id="status_dd" class="col-md-4" style="margin-top: -30px;">
															<select class="form-control input-small select2me" id="selectFeaturesStatus_ul">
																<option value="2" ><a href="#">ALL</a></option>
																<option value="1" selected><a href="#">Active</a></option>
																<option value="0" ><a href="#">Inactive</a></option>
															</select>
											...
											<div id="jTableContainerfeatures" class ="jTableContainerFullScreen"></div>
										</div>-->
										
										<div style="clear:both;padding-top:10px;position: relative">
											<div id="filterFeatureStatus" class="jScrollTitleContainer" style="position: absolute;z-index: 10;right: 165px;margin-top: 3px;display: block;">
												<div id="featureStatus_dd" class="col-md-4">
													<select class="form-control input-small select2me" id="featureStatus_ul">
														<option value="2" selected><a href="#">ALL</a></option>
														<option value="1" ><a href="#">Active</a></option>
														<option value="0"><a href="#">Inactive</a></option>
													</select>
									...
									<!-- TestSuites -->
									<!-- <div id="Testsuites" class="tab-pane fade">
										ContainerBox
										<div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top:10px;min-height: 270px">
											<div id="jTableContainertestsuite" class ="jTableContainerFullScreen"></div>
											End Container Box
										</div>
									</div> -->
									...
									<!-- Test Plan Starts -->
									<%-- <div id="TestRunPlanTab" class="tab-pane fade">
										<div><%@include file="testRunPlan.jsp"%></div>
										<div id="tcRadioGrp" class="radio-toolbar col-lg-8 toolbarFullScreen hidden">								
											<div class="btn-group trp_radGrp" data-toggle="buttons" style="width:100%">
												<label class="btn darkblue active " onclick="showCorrespondingTableTestRun(1);">
												<input type="radio" class="toggle" >Test Plan</label>
												<label class="btn darkblue" onclick="showCorrespondingTableTestRun(2);">
												<input type="radio" class="toggle" >Test Plan Group</label>
											</div>
										</div>
										<!-- <div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top:10px;" >
											<div id="jTableContainertestrun" class ="jTableContainerFullScreen"></div>
											<div id="dataTableContainerForTestPlan"></div>
										</div> -->
										...
										<jsp:include page="testRunPlan.jsp"></jsp:include>
									</div> --%>
									<!-- Test Plan Ends -->
									...
									<!-- <div id="TestRunPlan" class="tab-pane fade">
										<div class="jScrollContainerResponsive" style="clear:both;padding-top:10px">
											<div id="jTableContainerTestRunPlanById"></div>
										</div>
									</div>  -->
									<!-- TestSuites Ends -->
									
									<!-- Product Team Resources -->
									<div id="ProductTeamResources" class="tab-pane fade">
										<!-- ContainerBox -->
										<!-- <div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top:10px">
											<div id="jTableContainerProductTeamResources" class ="jTableContainerFullScreen"></div>
										</div> -->
										<!-- End Container Box -->
									</div>
									...
									<!-- Product Bots -->
									<%-- <div id="productBots" class="tab-pane fade">										
										<div class="jScrollContainerResponsive" style="clear:both;padding-top:10px">
											<jsp:include page="productBotDetails.jsp"></jsp:include>
										</div>
									</div> --%>
									<!-- Product Bots -->
									...
									<div id="UserGroup" class="tab-pane fade">
										<!-- ContainerBox -->
										<!-- <div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top:10px">
											<div id="jTableUserGroups" class ="jTableContainerFullScreen"></div>
										</div> -->
									...
									<div id="Risks" class="tab-pane fade ">
										...
										<div class="jtbToolRisk" style="clear:both;padding-top:10px;position: relative;">
											...
											<!-- <div id="jTableContainerRisks" class ="jTableContainerFullScreen"></div> -->
										...
										<div class="jtbToolSeverity" style="clear:both;padding-top:10px;position: relative;">
											...
											<!-- <div id="jTableContainerRiskSeverity" class ="jTableContainerFullScreen"></div> -->
										...
										<div class="jtbToolLikeHood" style="clear:both;padding-top:10px;position: relative;">
											...
											<!-- <div id="jTableContainerRiskLikeHood" class ="jTableContainerFullScreen"></div> -->
										...
										<div class="jtbToolMitigation" style="clear:both;padding-top:10px;position: relative;">
											...
											<!-- <div id="jTableContainerRiskMitigation" class ="jTableContainerFullScreen"></div> -->
										...
										<div class="jtbToolRating" style="clear:both;padding-top:10px;position: relative;">
											...
											<!-- <div id="jTableContainerRiskRating" class ="jTableContainerFullScreen"></div> -->
									...
									<div id="TraceabilityReport" class="tab-pane fade" style="display:none">		
										<div id="traceabilityReportRiskRadioGrp" class="radio-toolbars">								
											...
											<div class="jScrollContainerResponsive jtbToolDefectReport jScrollContainerFullScreen" style="clear:both;padding-top:5px;">
											    <!-- <div class="caption caption-md" style="margin:0px;">
													<span class="caption-subject theme-font bold uppercase">Defect Report - Fix Fail Details:</span>
												</div> --> 
											...
											<!-- END PORTLET-->			
												<!-- <div class="jScrollContainerResponsive" style="clear:both;padding-top:10px;position: relative;">
													<div class="row" style="position:  absolute;Z-index: 10;margin-left:200px">
												  		ContainerBox
												   		
													</div>
													<div id="jTableContainerDefectReport"></div>
													End Container Box
												</div> -->
											<!-- Traceability Report -->									
									...
									<div id="AutomationScripts" class="tab-pane fade">
											...
											<div class="jScrollContainerResponsive jScrollContainerFullScreen" style="clear:both;padding-top: 5px;position: relative;min-height: 270px;">
												...
												<!-- <div class="col-lg-1" style="position: absolute;z-index: 10;width: 230px;margin-left: 500px;margin-top: 6px;padding-right: 0px;">
													
															<label style="font-size: 1.1em !important;color: #FFF;font-family: sans-serif;">Download : </label>
													
															<input style="margin-left: 4px;height: 26px;background-color:  #55616f;font-size: 0.9em;padding-top: 3px;margin-top: 2px;"
																type="button" class="btn blue"  value="TestCaseTemplate " onclick="downloadTemplate()">
												</div> --> 
									...
									<div class="TestTabPage  tab-pane fade" id="TestTabPage" style="overflow: hidden;height:73%;">
										...
										<div class="objectrepositoryTab" style="clear:both;padding-top:10px;margin-right:5px;">
											<!-- <div id="objRepoFilter" style="position:absolute;z-index:10;right:420px;margin-top:15px;">
												<div id="objRepoFilter_dd" class="col-md-8">
													<select class="form-control input-small select2me" style="font-size:13px !important;" id="objRepoFilter_ul">
														<option value="0" selected><a href="#">My ObjRepo</a></option>
														<option value="1"><a href="#">All ObjRepo</a></option>
													</select>
												</div>
											</div>		 -->									
									...
									<!-- Tests Tab Ends -->
									<!-- Mapping Feature To Build -->
									<!-- <div id="MappingFeatureToBuild" class="tab-pane fade">
										<div id="featureToBuildMappingContent"></div>
									</div> -->
									<!-- Mapping Feature To Build Ends -->
...
<!-- <div id="div_PopupRunConfigurationList" class="modal" tabindex="-1" aria-hidden="true" style="width: 96%; left: 2%; top: 2%; padding-top: 0px; padding-bottom: 0px; 
	padding-left: 19px;">
         ...
         <div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="col-md-12 col-lg-12">
						...
						<!-- <div class="form-group col-md-2 col-lg-2" style="padding-left:0px;padding-right:0px;">
							<div class="input-group">
								<div class="panel panel-default">
								  	<div class="panel-heading">Select Test Configuration(s)</div>
								  	<div id="run_configuration_list" class="panel-body icheck-list">Panel Content</div>
								</div>
							</div>
						</div> -->
						...
						<div class="col-md-12 col-lg-12">
							<div class="container" id="test" style="height: 100%; padding: 0px;margin-top: -20px !important;">								
								<div class="col-lg-12 col-md-12" id="treeJTableDivId"> 								
										...
										<!-- <div id="jTableContainerTestCaseForTestRunPlan"></div> -->
	...
	<div class="modal-full">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="scroller" style="height:500px" data-always-visible="1" data-rail-visible1="1">
					<!-- <div class="jScrollContainerResponsive" style="clear:both;padding-top:10px">
						<div id="jTableAssessmentHistory"></div>
					</div> -->
...
<!-- <div id="tpgWorkpackagesDT_Child_Container" class="modal fade" id="full" tabindex="-1" role="dialog" aria-hidden="true">
   	<div class="modal-full">
       	 <div class="modal-content" style="min-height:500px">
        
			<div class="modal-header" style="padding-bottom: 5px;">
				<button type="button" class="close" data-dismiss="modal" title="Press Esc to close" aria-hidden="true"></button>
				<h4 class="modal-title theme-font">Workpackages</h4>
			</div>
			<div class="modal-body">
				<div id="enviornmentChildLoaderIcon"  style="display:none; vertical-align: middle;z-index:100001;position:absolute;top:5px;right:50%">	
					<img src="css/images/ajax-loader.gif"/>
				</div>					 
	 			<div id="dataTableContainerForTPGWorkpackages"></div>	 								 
			</div>
		</div>
	</div>
</div>-->
...
<div id="listTestdataDT_Child_Container" class="modal" tabindex="-1" aria-hidden="true" style="width: 96%;left: 2%;top: 2%; padding: 0px;">
	...
	<div id="ChildTableTestdataVaues_Child_Container" class="modal" tabindex="-1" aria-hidden="true" style="width: 96%;left: 2%;top: 2%; padding: 0px;">
			<div class="modal-full">
				<div class="modal-content">
					<div class="modal-header" style="padding-bottom: 5px;">
						<button type="button" class="close" data-dismiss="modal" title="Press Esc to close" aria-hidden="true"></button>
					...
					<div class="modal-body">					
						 <div class="scroller" style="height: 500px" data-always-visible="1" data-rail-visible1="1">
			 				<div id=dataTableContainerForTestdataValues></div>
			 			</div>					 
					</div>
				</div>
		</div>
	...
	<div id="div_testManagementSynData" class="modal " tabindex="-1" aria-hidden="true">
	<div class="modal-dialog" style="width: 600px;">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" title="Press Esc to close" aria-hidden="true" onclick="closeCloningContainer()"></button>
				<h4 class="modal-title caption-subject theme-font">Data Sync</h4>
			</div>
			<div class="modal-body" style="padding: 0px;">
								<div class="portlet light">								
							<div class="portlet-body form">
									...
									<form role="form">
										<div class="form-body" style="padding-top: 0px;padding-bottom: 0px;">									
											<div class="form-group">													
													...
													<div class="input-group">
															<div id="testManagementCheckBoxes" style="display:grid">
																<label>FEATURES <input id="syncFeatures" type="checkbox" value="syncFeatures" checked="checked"></label>	
																<label>TESTCASES <input id="syncTestcases" type="checkbox" value="syncTestcases" checked="checked"></label>
		   														<label>TESTSUITES <input id="syncTestsuites" type="checkbox" value="syncTestSuites" checked="checked"></label>
															</div>
															<div id="testManagementMappingsCheckBoxs" style="display:grid">
		   														<label>TESTCASES TO TESTSUITES MAPPING<input id="syncTestcasesToTestsuitesMapping" type="checkbox" value="workPackage" checked="checked"></label>
																<label>FEATURES TO TESTCASES MAPPING<input id="syncFeaturesToTestcasesMapping" type="checkbox" value="workPackage" checked="checked"></label>
	   														</div>
	   														<div id="defectManagementCheckBoxs" style="display:grid">
		   														<label>EXPORT DEFECTS<input id="reportDefects" type="checkbox" value="exportDefects" checked="checked"></label>
																<!-- <label>EXPORT RESULTS<input id="reportResults" type="checkbox" value="exportResults" checked="checked"></label> -->
	   														</div>
													</div>
											</div>																					 													
										...
										<div class="form-actions" style="padding-top: 5px;padding-bottom: 5px;">
										<button type="button"  id = "synTestManagementBtn" onclick="submitSyncTestmanagement();" class="btn green-haze" style="padding: 6px 6px;" >Submit</button>
											<button type="button" class="btn grey-cascade" onclick="popupCloseSyncTestmanagementHandler()">Cancel</button>
...
<!-- Product Bots Child Popup end-->
	...
	<script type="text/javascript">	
		...
		function featureOverAllView(event){
			var rawdata = event.target.id;
			var splitdata = rawdata.split(/[~@]+/);
			var featureId = splitdata[0];
			var featureName = splitdata[1];
