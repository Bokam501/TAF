    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        *************************************************************************/		
        _toolbarsearch_createHeaderCellForField: function (fieldName, field) {
            ...
            // ----- modified -----
            var $input="";
            if(field.options != undefined && field.toolbarsearchComboBox != undefined){
            	$input = this._getDisplayComboBox(fieldName,field);            	

            }else if(field.type!=undefined && field.type=="date"){
            	$input = $('<input id="jtable-toolbarsearch-' + fieldName + '" type="text"/>')
	            .addClass('jtable-toolbarsearch')
	            .css('width','90%');
