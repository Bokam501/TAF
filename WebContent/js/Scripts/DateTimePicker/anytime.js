...
//			    	e.preventDefault();
      ...
      $(window).off('resize',this.hResize);
		...
		dismiss: function(event)
		{
			...
			this.div.hide();
			this.lostFocus = true;
			globalanytimehandler.isChanged = true;
			console.log(globalanytimehandler)
		},
		...
		{
			globalanytimehandler.isChanged = false;
//			var currVal = this.id.replace("AnyTime--","");
//			datepickerCurrentValue = document.getElementById(currVal).value;
