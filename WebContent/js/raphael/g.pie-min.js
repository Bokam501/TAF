...
(function () {
    function t(f, k, l, i, d, b) {
        ...
        if (1 == o) n.push(f.circle(k, l, i).attr({
            fill: b.colors && b.colors[0] || this.colors[0],
            stroke: b.stroke || "#fff",
            ...
            for (c = 0; c < o; c++) if (r && 100 * d[c] / j < e && (g = c, r = !1), c > g) r = !1, d[g].value += d[c], d[g].others = !0, p = d[g].value;
        ...
        a.hover = function (c, b) {
            for (var b = b ||
            function () {}, e = this, a = 0; a < o; a++)(function (a, f, g) {
                var h = {
                    sector: a,
                    cover: f,
                    cx: k,
        ...
        if (b.legend) {
            ...
            a.labels.translate.apply(a.labels, {
                east: [0, -f.height / 2],
                west: [-f.width - 2 * i - 50, -f.height / 2],
